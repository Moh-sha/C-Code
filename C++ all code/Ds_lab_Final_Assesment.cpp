...
int main() {
    ...
    ls.Delete(x);
    ls.display();
    cout << "enter a element to search in linked list: ";
    cin >> x;
    if(ls.search(x)) {
        cout << "element " << x << " found in the linked list\n";
    }else {
        cout << "element " << x << " is not found in the linked list";
    }

    cout << "\nBST inorder traversal : ";
    bst.inorder(bst.root);
    cout << "\nenter a element to search in BST: ";
    cin >> x;
    if(bst.search(bst.root, x)) {
        cout << "element " << x << " found in the BST\n";
    }else {
        cout << "element " << x << " is not found in the BST";
    }
    cout << "\nenter a element to delete from BST: ";
    cin >> x;
